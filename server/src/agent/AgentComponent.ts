...
import type { AgentScriptRuntimeState } from "./AgentScript";
...
export interface AgentComponent {
    ...
    /**
     * Bounded FIFO of recent high-signal events. The event bridge appends to
     * this whenever the world emits something relevant to the agent so the
     * next perception snapshot carries a short local history.
     */
    recentEvents: AgentPerceptionEvent[];

    /**
     * Optional long-running script currently installed on the agent. Scripts
     * are declarative state machines that can be generated by Milady agents,
     * paused by wait states, and interrupted by server/runtime events.
     */
    script?: AgentScriptRuntimeState;
}
