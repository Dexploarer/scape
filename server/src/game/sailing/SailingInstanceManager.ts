...
export class SailingInstanceManager {
    ...
    buildDockedCollision(): void {
        ...
        // The template scene only has base terrain — boat locs are extra.
        // Apply their collision shapes to the collision maps.
        // Scene base: (regionX - 6) * 8 = (480 - 6) * 8 = 3792, (800 - 6) * 8 = 6352
        const sceneBaseX = (SOURCE_BASE_X / 8 - 6) * 8;
        const sceneBaseY = (SOURCE_BASE_Y / 8 - 6) * 8;
        // Only apply collision for invisible blocker locs (id 32545, shape 22).
        // Shape 10 superstructure locs are walkable surfaces.
        // Sound locs (58569, 58526, 58568) are shape 22 but don't block.
